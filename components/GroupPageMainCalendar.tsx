            ...
            <CardHeader>
                <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground pl-12">
                        All events will be synced to this calendar
                    </p>
                </div>
            </CardHeader>
            <CardContent>
                <div className="flex items-center justify-between p-4 rounded-xl border border-primary/30 bg-primary/5 hover:bg-primary/10 transition-all">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-lg bg-background border shadow-sm flex items-center justify-center p-2">
                            <Image
